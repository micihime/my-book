...
export default function About() {
  return (
    <Stack>
      ...
      <Text>
        This book was inspired by stories my father used to tell me when I was a
        child. Although I only remember a few of them, those memories sparked my
        imagination to create new tales of my own, blending the warmth of his
        storytelling with fresh ideas that can inspire young readers today.
      </Text>
      <Text>
        Each story reminds us that it&apos;s okay to be scared, but with good
        friends by your side, you can overcome any obstacle.
      </Text>

      <Heading as="h2">Meet the Characters</Heading>
      <Text>Frog, Snake, Rabbit</Text>
      <Text>
      ...
      <Text>
        ...
        life for a new generation of readers. I&apos;m passionate about
        storytelling and illustration, and this book is the start of a dream to
        create magical, inspiring stories for children.
      </Text>
      <Button variant="subtle" asChild w="fit-content">
