...
export default function Author() {
  return (
    <>
      ...
      <Text>
        This project is also deeply personal to me. Growing up, my father used
        to tell me stories about the forest and its wonderful creatures. Those
        stories are precious memories from my childhood, and even though I only
        remember a few of them, they&apos;ve inspired me to continue his legacy
        by writing new tales for a new generation.
      </Text>
      <Text>
        Through these stories, I hope to share the important lessons that I
        learned the hard way. I want kids to know that it&apos;s okay to ask for
        help, that friendship and kindness are priceless, and that it&apos;s
